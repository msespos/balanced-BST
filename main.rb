class Node
  ...
  # Build a Node class. It should have attributes for the data it stores
...
class Tree
  ...
  # #build_tree method which takes an array of data (e.g. [1, 7, 4, 23, 8, 9, 4, 3, 5, 7, 9, 67, 6345, 324])
  ...
  # #insert and #delete method which accepts a value to insert/delete
    ...
    # #inorder, #preorder, and #postorder methods that returns an array of values. Each method should
